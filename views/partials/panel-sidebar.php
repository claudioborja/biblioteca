            ...
            <details class="group rounded-[0.5rem]" <?= str_starts_with($_path, '/admin/resources') ? 'open' : '' ?>>
                ...
                <div class="ml-6 mb-2 mt-0.5 space-y-0.5 border-l border-outline-variant/60 pl-2 text-[12px]">
                    ...
                    $_resLinks = [
                        ...
                        ['Revistas',        '/admin/resources/type/revistas',      true],
                        ['Artículos',       '/admin/resources/type/articulos',     true],
                        ['Tesis',           '/admin/resources/type/tesis',         true],
                        ['Mapas',           '/admin/resources/type/mapas',         true],
                        ['Partituras',      '/admin/resources/type/partituras',    true],
                        ['Audiovisuales',   '/admin/resources/type/audiovisuales', true],
                        ['Juegos',          '/admin/resources/type/juegos',        true],
                        ['Kits',            '/admin/resources/type/kits',          true],
