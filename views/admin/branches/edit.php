...
<section class="p-6 lg:p-8">
    ...
    <div class="mb-7 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
            ...
            <h1 class="headline-lg text-on-surface">Editar sede</h1>
            <p class="body-md mt-1">Actualiza los datos de la sede «<?= $e($branch['name']) ?>».</p>
        </div>
    ...
    <form method="POST" action="<?= BASE_URL ?>/admin/branches/<?= (int) $branch['id'] ?>" class="space-y-6">
        ...
        <div class="rounded-3xl border border-outline-variant/60 bg-white p-5 shadow-ambient-lg lg:p-6 space-y-5">
            ...
            <div>
                ...
                <p class="body-md mt-1">Datos identificativos y de contacto de la sede.</p>
            </div>
        ...
        <div class="rounded-2xl border border-outline-variant/60 bg-white px-4 py-3 shadow-ambient">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div class="text-xs text-on-surface-muted">
                    <span class="inline-flex items-center gap-1.5 rounded-full bg-white/85 px-3 py-1.5">
                        <i class="bi bi-building text-[12px]"></i>
                        Sede #<?= (int) $branch['id'] ?> · creada <?= $e(date('d/m/Y', strtotime($branch['created_at']))) ?>
                    </span>
                </div>
