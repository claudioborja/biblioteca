            ...
            <section id="section-inventario" data-tab-panel="inventario" class="hidden space-y-5">
                ...
                <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    <div>
                        ...
                        <p id="cover-error-edit" class="mt-1 hidden text-xs font-semibold text-red-600"></p>
...
(() => {
    window.initCoverImageInput?.({
        ...
        previewWrap: document.getElementById('cover-preview-edit'),
        previewImg:  document.getElementById('cover-preview-img-edit'),
        errorEl:     document.getElementById('cover-error-edit'),
        maxMB: 5,
    });
})();
